...
const Submissions = () => {
  ...
  useEffect(() => {
    ...
    fetchWorkRequests();
  }, [page, limit, category, sortByField, sortOrder, debouncedSearchTerm, hasMounted, sessionStatus]); // Removed workRequests.length from deps as it can cause infinite loop
    ...
    <div className="container mx-auto my-6 px-4 md:px-6 lg:px-8">
      ...
      {selectedRequest && (
        <WorkRequestModal
          ...
          // You might pass the search params for `submission` or `message` to the modal
          // if your modal needs to scroll to specific sections.
