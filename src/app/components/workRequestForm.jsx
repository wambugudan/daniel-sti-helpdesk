// File: src/app/components/workRequestForm.jsx
"use client";
...
const WorkRequestForm = ({ requestId }) => {
  ...
  const uploadFile = async (file, bucketName) => {
    // A new FormData object is created to prepare the data for the POST request
    const formData = new FormData();
    // The file is appended to the FormData object under the key "file"
    formData.append("file", file);
    // The bucket name is appended to the FormData object under the key "bucket"
