...
//   // ✅ Local state for composing new conversation messages
...
//     fetchMessages,
//     sendMessage,
//   } = useConversation(resolvedContract?.id, resolvedContract?.currentUser);
...
const ContractModal = ({ contract, contractData, onClose, handleCancelContract }) => {
  ...
  const {
    ...
    submissionId,
    resolvedContract?.currentUser?.id,
    resolvedContract?.currentUser?.role
  );
