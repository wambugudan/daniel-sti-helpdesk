...
//   const [requestData, setRequestData] = useState(workRequest); // Initial from props
...
//   // Re-fetch full workRequest with bids using x-user-id
//   useEffect(() => {
//     const fetchWorkRequest = async () => {
//       try {
//         const res = await fetch(`/api/work-request/${workRequest.id}`, {
//           headers: {
//             'x-user-id': currentUser.id,
//           },
//         });

//         if (!res.ok) throw new Error("Failed to fetch updated work request");
//         const updatedWorkRequest = await res.json();

//         // Optional: log to verify
//         console.log("🔁 updated workRequest:", updatedWorkRequest);

//         // Replace the bids in current workRequest (note: you can't mutate props directly)
//         workRequest.bids = updatedWorkRequest.bids;
//       } catch (error) {
//         console.error("❌ Error updating work request with bids:", error);
//       }
//     };

//     if (isCouncil && isOwner) {
//       fetchWorkRequest();
//     }
//   }, [currentUser.id, workRequest.id]);
...
//   console.log("🧪 workRequest.bids:", workRequest.bids);
...
//                         </p>
//                         {bid.message && (
//                           <p className="mt-1 text-sm">{bid.message}</p>
//                         )}
//                       </div>
//                     ))}
//                 </div>
